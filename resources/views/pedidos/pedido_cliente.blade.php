                    ...
                    <div class="flex flex-col">
                        @forelse ($pedidos as $pedido)
                            <div class="border rounded-lg p-2 dark:border-gray-600">
                                ...
                                <p class="px-3 dark:text-gray-300"><span class="font-bold">Cliente:</span> {{ $pedido->cliente->user->name }}</p>
                                ...
                                <p class="px-3 dark:text-gray-300"><span class="font-bold">Método de pago:</span> {{ $pedido->metodoPago->nombre }}</p>
                                <p class="px-3 lowercase flex flex-col">
                                    <span class="font-bold capitalize dark:text-gray-200">Descripción: </span>
                                    @foreach ($pedido->detalles as $detalle)
                                        <div class="flex justify-between w-1/2 mb-3">
                                            <p class="px-3 dark:text-gray-300"><span class="font-bold">Pizza:</span> {{ $detalle->pizza->nombre }}</p>
                                            <p class="px-3 dark:text-gray-300"><span class="font-bold">Cantidad:</span> {{ $detalle->cantidad }}</p>
                                        </div>
                                    @endforeach
                                </p>
                            </div>
